...
# 2 "<built-in>" 2
# 1 "../00-libfiles/uart.c" 2
# 41 "../00-libfiles/uart.c"
# 1 "D:\\software\\MPLAB\\XC8 COMPILER\\pic\\include\\c90\\stdarg.h" 1 3
...
# 42 "../00-libfiles/uart.c" 2
# 1 "../00-libfiles/uart.h" 1
# 44 "../00-libfiles/uart.h"
...
# 46 "../00-libfiles/uart.h" 2
# 99 "../00-libfiles/uart.h"
...
# 169 "../00-libfiles/uart.c"
void UART_TxString(const char *ptr_string)
{
    while(*ptr_string)
        UART_TxChar(*ptr_string++);
}
# 198 "../00-libfiles/uart.c"
uint8_t UART_RxString(char *ptr_string)
{
    char ch;
    uint8_t len = 0;
...
void UART_TxNumber(uint8_t v_numericSystem_u8, uint32_t v_number_u32, uint8_t v_numOfDigitsToTransmit_u8)
{
    ...
    if(2u == v_numericSystem_u8)
    {
        while(v_numOfDigitsToTransmit_u8!=0)
        {
            ...
            i = (((v_number_u32)&((1<<((v_numOfDigitsToTransmit_u8-1)))))!=0u);
            UART_TxChar(((i)+0x30));
    ...
    else
    {
        ...
        while(i)
        {
            ...
            UART_TxChar((((a[i-1])>0x09) ? ((a[i-1]) + 0x37): ((a[i-1]) + 0x30)));
            i--;
        }
    }
        ...
        if(ch == '%')
        {
           ...
           if((ch>=0x30) && (ch<=0x39))
            ...
            case 'd':
                ...
                UART_TxNumber(10u,v_num_s16,v_numOfDigitsToTransmit_u8);
                break;
            ...
            case 'D':
                ...
                UART_TxNumber(10u,v_num_s32,v_numOfDigitsToTransmit_u8);
                break;

            case 'u':
                v_num_u16 = (*(uint16_t *)__va_arg((*(uint16_t **)argp), (uint16_t)0));
                UART_TxNumber(10u,v_num_u16,v_numOfDigitsToTransmit_u8);
                break;

            case 'U':
                v_num_u32 = (*(uint32_t *)__va_arg((*(uint32_t **)argp), (uint32_t)0));
                UART_TxNumber(10u,v_num_u32,v_numOfDigitsToTransmit_u8);
                break;

            case 'x':
                v_num_u16 = (*(uint16_t *)__va_arg((*(uint16_t **)argp), (uint16_t)0));
                UART_TxNumber(16u,v_num_u16,v_numOfDigitsToTransmit_u8);
                break;

            case 'X':
                v_num_u32 = (*(uint32_t *)__va_arg((*(uint32_t **)argp), (uint32_t)0));
                UART_TxNumber(16u,v_num_u32,v_numOfDigitsToTransmit_u8);
                break;
            ...
            case 'b':
                ...
                UART_TxNumber(2u,v_num_u16,v_numOfDigitsToTransmit_u8);
                break;
            ...
            case 'B':
                ...
                UART_TxNumber(2u,v_num_u32,v_numOfDigitsToTransmit_u8);
                break;
